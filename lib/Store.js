...
function sanitizeSettings(raw) {
  ...
  return { autosaveMinutes: minutes, autosaveEnabled: enabled, editorZoom: zoom, previewEnabled: previewEnabled, lineNumbersEnabled: lineNumbersEnabled, narrowMarginsEnabled: narrowMarginsEnabled, rightPaneHidden: rightPaneHidden, claudeModel: claudeModel, claudeEffort: claudeEffort }
}
